$(function() {
	// 获取此店铺下的商品列表的URL
	var listUrl = '/platform/productadmin/getproductlistbyshop?pageIndex=1&pageSize=999';
	// 商品下架URL
	var statusUrl = '/platform/productadmin/modifyproduct';
	getList();
	/**
	 * 获取此店铺下的商品列表
	 * 
			...
			.on(
					...
					function(e) {
						...
						if (target.hasClass('edit')) {
							...
							window.location.href = '/platform/productadmin/productoperation?productId='
							...
							window.location.href = '/platform/frontend/productdetail?productId='
									+ e.currentTarget.dataset.id;
						}
					});
