...
$(function() {
	...
	var infoUrl = '/platform/productadmin/getproductbyid?productId=' + productId;
	// 获取当前店铺设定的商品类别列表的URL
	var categoryUrl = '/platform/productadmin/getproductcategory';
	// 更新商品信息的URL
	var productPostUrl = '/platform/productadmin/modifyproduct';
	// 由于商品添加和编辑使用的是同一个页面，
	// 该标识符用来标明本次是添加还是编辑操作
	var isEdit = false;
	if (productId) {
		...
		getCategory();
		productPostUrl = '/platform/productadmin/addproduct';
	}
